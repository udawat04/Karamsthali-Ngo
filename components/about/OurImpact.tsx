      ...
      <div className="max-w-[1320px] mx-auto px-5 md:px-7 lg:px-10 flex flex-col lg:flex-row gap-16 lg:gap-20 items-center">
        ...
        <div className="w-full lg:w-1/2 flex flex-col items-start gap-8 z-10">
          ...
          <h2 className="text-h2 font-bold leading-[1.15] text-brand-dark tracking-tight">
            Creating Change That <br className="hidden lg:block" /> Truly
            Matters
          </h2>
          ...
          <p className="text-brand-dark/70 text-[1.05rem] md:text-lg leading-relaxed max-w-xl">
            ...
            commitment, we ensure every effort leads to meaningful and lasting
            impact.
          </p>
              ...
              <div className="relative z-10 h-full flex flex-col justify-between">
                <div>
                  <div className="flex items-start mb-6">
                    <span className="text-5xl font-bold text-brand-dark tracking-tight transition-colors duration-500">
                      4500
                    </span>
                    <span className="text-4xl font-bold text-primary relative -top-1 ml-0.5 group-hover:text-brand-dark transition-colors duration-500">
                      +
                    </span>
                  </div>
