        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 xl:gap-24 items-center">
          ...
          <div className="lg:col-span-5 order-2 lg:order-1">
            <div className="relative w-full" style={{ paddingBottom: "115%" }}>
              ...
              <div className="absolute top-0 left-0 w-[55%] aspect-square opacity-90 pointer-events-none select-none z-0">
                <Image
                  src="https://html.awaikenthemes.com/aasha/images/about-us-image-box-bg-prime.png"
                  alt="Decorative watermark"
                  fill
                  className="object-contain"
                  unoptimized // External theme assets sometimes bypass Next.js optimization
                />
              </div>

              {/* ② Main Photo: Using hero-banner-1.jpeg from public folder */}
              <div
              ...
              >
                <Image
                  ...
                  fill
                  priority // Faster loading for main visual elements
                  className="object-cover transition-transform duration-700 hover:scale-105"
                />
              </div>

              {/* ③ Small overlapping photo: Using hero-banner-2.jpeg from public folder */}
              <div
          ...
          <div className="lg:col-span-7 flex flex-col items-start order-1 lg:order-2">
            ...
            {/* Headline */}
            <h2 className="text-4xl md:text-5xl lg:text-h2 font-extrabold text-brand-dark leading-[1.05] tracking-tight mb-8 font-headline">
              Championing Causes <br className="hidden md:block" /> that Truly
              Matter
            </h2>

            {/* Description */}
            <p className="text-gray-500 text-lg md:text-xl font-stack-sans leading-relaxed mb-12 max-w-2xl">
              We are dedicated to addressing the most pressing social challenges
              affecting our communities. Through advocacy, grassroots action,
